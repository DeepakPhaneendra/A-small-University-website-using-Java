...
try
{
	...
	{
		PreparedStatement st1=con.prepareStatement("update student set name=? where roll=?");
		PreparedStatement st2=con.prepareStatement("update sverify set password=? where roll=?");
